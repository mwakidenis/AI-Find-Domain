...
export const metadata: Metadata = {
  ...
  description:
    "Complete documentation for Find My Domain CLI tool and API. Learn how to generate AI-powered domain names using OpenAI, check WHOIS availability, and integrate with your Node.js projects. Includes installation guides, CLI examples, and TypeScript API reference.",
  keywords: [
  ...
  alternates: {
    canonical: "https://find-my-domain.vercel.app/docs",
  },
  openGraph: {
    title: "Documentation - Find My Domain CLI & API Reference",
    description:
      "Complete documentation for Find My Domain CLI tool and API. Installation guides, CLI examples, and TypeScript API reference.",
    url: "https://find-my-domain.vercel.app/docs",
    type: "website",
  },
  twitter: {
    card: "summary",
    title: "Find My Domain - Documentation",
    description:
      "Complete CLI and API documentation for AI-powered domain generation",
  },
};
                ...
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="faq-1">
                    ...
                    <AccordionContent className="space-y-3">
                      <p className="text-sm text-muted-foreground">
                        Find My Domain is{" "}
                        <strong>100% free and open source</strong> (MIT
                        license). You only need an OpenAI API key, which has its
                        own pricing:
                      </p>
                      <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground ml-4">
                        <li>
                          <strong>gpt-4o-mini</strong>: $0.15 per 1M input
                          tokens (very affordable)
                        </li>
                        <li>
                      ...
                      <div className="space-y-3">
                        <div className="rounded-lg border p-3">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Best balance of speed, cost, and quality. Perfect
                            for most use cases.
                          </p>
                        </div>
                        <div className="rounded-lg border p-3">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Higher quality, more creative names. Use for
                            important projects.
                          </p>
                        </div>
                        <div className="rounded-lg border p-3">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Premium quality. Best for finding that perfect,
                            unique domain.
                          </p>
                        </div>
                      </div>
                  ...
                  <AccordionItem value="faq-4">
                    ...
                    <AccordionContent className="space-y-3">
                      <p className="text-sm text-muted-foreground">
                        WHOIS checking is <strong>highly accurate</strong>{" "}
                        (95%+) but not 100% guaranteed:
                      </p>
                      <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground ml-4">
                        <li>
                        ...
                        <li>
                          <strong>Taken</strong>: Domain is registered and not
                          for sale
                        </li>
                      </ul>
                      <p className="text-sm text-muted-foreground">
                        <strong>Important:</strong> Always verify availability
                        on your registrar before purchasing. WHOIS data can have
                        a slight delay (~24-48 hours).
                      </p>
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  <AccordionItem value="faq-5">
                    ...
                    <AccordionContent className="space-y-3">
                      <p className="text-sm text-muted-foreground">
                        Yes! Find My Domain is MIT licensed and can be
                  ...
                  <AccordionItem value="faq-7">
                    ...
                    <AccordionContent className="space-y-3">
                      ...
                      <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground ml-4">
                        ...
                        <li>
                          <strong>WHOIS lookups</strong>: Anonymous public
                          queries
                        </li>
                        <li>
                          <strong>No tracking</strong>: We don&apos;t collect
