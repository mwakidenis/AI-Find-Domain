...
export function UseCases() {
  return (
    <section id="use-cases" className="container py-16 md:py-20 bg-muted/30">
      ...
      <div className="mt-16 text-center">
        <Card className="mx-auto max-w-2xl bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20">
